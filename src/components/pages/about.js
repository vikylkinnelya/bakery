                    ...
                    <div className="section-content">
                            ...
                            <Row>
                                ...
                                <Col md={6} className=" onscroll-animate" data-delay="400">
                                    ...
                                    <section id="video-section" className="section-white-cover parallax-background">
                                        <div className="section-content">
                                            <div className="container onscroll-animate">
                                                <div className="margin-40"></div>
                                                <h2 className="heading-huge">Video presentation</h2>
                                                <div className="margin-20"></div>
                                                <div className="embed-responsive embed-responsive-4by3">
                                                    <iframe className="embed-responsive-item" src="http://www.youtube.com/embed/OhtG_XahQco"></iframe>
                                                </div>
